...
// Graph to download
const clickToPdfTwo = document.getElementById('downloadPdf2');
//var clickToPdf = document.getElementById('downloadPdf');
let canvasTwo = document.getElementById('myChart');
clickToPdfTwo.addEventListener('click', () => {
	canvasTwo.toBlob(function(blob) {
		let pdf = new jsPDF('p', 'px', [ 400, 400 ]);
		pdf.addImage(canvasTwo, 0, 0, 400, 400);
